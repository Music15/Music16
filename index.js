...
//البرفكس
const prefix = "nh!"; // تعديل مهم حط هنا البرفكس او مقدمة الامر
...
.setThumbnail(message.author.avatarURL)
 .setDescription(`** Commands Help Music :hammer_pick: 
...
client.on('message', message => {
           const prefix = 'nh!'; //! Keep?Sky#2144
     if (message.content === (prefix + "help music")) { //! Keep?Sky#2144
